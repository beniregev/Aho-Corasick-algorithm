...
/**
 * <div>
 *     Matches leftmost shortest matches. Useful when you want
 *     non-overlapping matches with a string set that doesn't
 *     have strings that are prefix to other strings in the set.
 * </div>
